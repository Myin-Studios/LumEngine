...
constexpr auto qt_meta_stringdata_CLASSRendererENDCLASS = QtMocHelpers::stringData(
    "Renderer",
    "updatePosition",
    "",
    "Vec3",
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updatePosition((*reinterpret_cast< std::add_pointer_t<Vec3>>(_a[1]))); break;
        default: ;
        }
