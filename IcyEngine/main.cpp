...
{
    std::filesystem::path absPath = std::filesystem::absolute("../../IcyEngine/");

    _putenv_s("ICY_BASE_DIR", absPath.string().c_str());
    ...
    SetEnvironmentVariable(L"MSBUILD_DIR", L"C:/Program Files/Microsoft Visual Studio/2022/Community/MSBuild/Current/Bin/");
